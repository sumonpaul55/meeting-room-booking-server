...
const bodyParese_1 = __importDefault(require("../../middileWare/bodyParese"));
const multer_config_1 = require("../../config/multer.config");
const router = express_1.default.Router();
router.post("/signup", multer_config_1.multerUpload.single("image"), bodyParese_1.default, (0, validateRequest_1.default)(user_validation_1.userValidations.createUserValidationSchma), auth_controller_1.authController.signUp);
