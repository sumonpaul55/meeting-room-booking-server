...
router.post("/", (0, authGuared_1.default)(user_constant_1.USER_ROLE.admin), (0, validateRequest_1.default)(slot_validation_1.slotValidation.addSlotValidationSchema), slot_controller_1.slotController.addSlot);
